    ...
    <div class="container-fluid  dashboard-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo base_url('Sellerawork/AddHotel');?>" method="post"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    ?>" id="hotelname" name="hotelname" value="<?php echo set_value('hotelname');?>">
                                </div>
                                <!----->
                                ...
                                ?>" id="hotelid" name="hotelid" value="<?php echo set_value('hotelid');?>">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    ?> text-uppercase" id="hotelconnum" name="hotelconnum"
                                        value="<?php echo set_value('hotelconnum');?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                ?>" id="hoteladd" placeholder="Hotel Address "
                                        value="<?php echo set_value('hoteladd',);?>" name="hoteladd">
                                </div>
                                ...
                                ?>" id="nearlandmark" placeholder="Landmark "
                                        value="<?php echo set_value('nearlandmark');?>" name="nearlandmark">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    $selectd = ($data->state == $st->id)? true: false; ?>
                                        <option <?php   echo set_select('state',$st->id);?>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Hotel Information</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" id="hotelinfo" name="hotelinfo" rows="3">
                                <?php echo set_value('hotelinfo'); ?>
                                </textarea>
                            </div>
                            ...
                            <button type="file" class="btn  btn-primary">Add Hotel</button>
                        </form>
                    </div>
                </div>
            </div>
